...
{
    public class CommitCrudFactory : CrudFactory
    {

        public CommitCrudFactory()
        {
        ...
        {
            var review = (Commit)baseDTO;
            var sqloperation = new SqlOperation()
            {
                ProcedureName = "sp_CreateCommit"
            };

            sqloperation.AddVarCharParameter("Key_id", review.Key_id);
            sqloperation.AddIntParameter("Version", review.Version);
